...
public class TransmogrifierPatches {
    private static final UIStrings STRINGS = CardCrawlGame.languagePack.getUIString(CardAugmentsMod.makeID("TransmogrifierEvent"));
            ...
            if (CardAugmentsMod.eventAddons) {
                if (___screenNum[0] == 0) {
                    ...
                    if (buttonPressed[0] == myIndex) {
                        ...
                        AbstractDungeon.gridSelectScreen.open(group, group.size() == 1 ? 1 : 2, TEXT[1], false, false, false, false);
                        choseMyOption = true;
                        try {
