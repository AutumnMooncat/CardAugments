...
public class ChimeraDeckForce extends ConsoleCommand {
    public ChimeraDeckForce() {
        requiresPlayer = true;
        minExtraTokens = 2;
        maxExtraTokens = 2;
    }
    ...
    public ArrayList<String> extraOptions(String[] tokens, int depth) {
        ArrayList<String> options = ConsoleCommand.getCardOptionsFromCardGroup(AbstractDungeon.player.masterDeck);
